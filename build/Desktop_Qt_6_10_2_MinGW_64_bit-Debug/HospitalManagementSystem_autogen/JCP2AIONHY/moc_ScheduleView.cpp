/****************************************************************************
** Meta object code from reading C++ file 'ScheduleView.hpp'
**
...
#include "../../../../include/ui/ScheduleView.hpp"
...
#error "The header file 'ScheduleView.hpp' doesn't include <QObject>."
...
template <> constexpr inline auto ScheduleView::qt_create_metaobjectdata<qt_meta_tag_ZN12ScheduleViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'updateSchedule'
        QtMocHelpers::SlotData<void(const std::vector<TimeSlot> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 2 },
        }}),
    };
...
void ScheduleView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateSchedule((*reinterpret_cast<std::add_pointer_t<std::vector<TimeSlot>>>(_a[1]))); break;
        default: ;
        }
    }
}
